...
- ok: Second or third-hand — heard it from someone, read it on Reddit, observed it once
- strong: Direct observation or repeated firsthand evidence — "I've seen three people do this manually in the last month"
...
- output_ready is always false in this prompt — the backend sets this, not Claude
